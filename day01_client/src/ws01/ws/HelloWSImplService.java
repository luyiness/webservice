 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.ws01/", wsdlLocation = "http://localhost:8989/day01/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://ws.ws01/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8989/day01/hellows?wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://ws.ws01/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ws01/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
